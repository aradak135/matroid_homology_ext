...
Array<Matrix<Int>> chains_of_flats(BigObject m) {
	...
	Array<Matrix<Int>> arrayOfChainMatrices(listOfChainMatrices.begin(), listOfChainMatrices.end());
	return arrayOfChainMatrices;
}
